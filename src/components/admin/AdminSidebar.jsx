...
function AdminSidebar({
  ...
  const iconMap = {
    ...
    "User Management": <Users size={21} strokeWidth={2} />,
    ...
    "Project Manager": <BriefcaseBusiness size={21} strokeWidth={2} />,
    ...
    "Reward Management": <Gift size={21} strokeWidth={2} />,
    "Reward Request": <Gift size={21} strokeWidth={2} />,
    "Reward History": <Gift size={21} strokeWidth={2} />,
    "Reward Settings": <Gift size={21} strokeWidth={2} />,

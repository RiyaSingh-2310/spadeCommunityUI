...
const ROUTE_RULES = [
  ...
  { matcher: /^\/user-screening\/panel-survey\/add/, module: "panel_survey", requiresWrite: true },
  { matcher: /^\/user-screening\/panel-survey\/edit\//, module: "panel_survey", requiresWrite: true },
  { matcher: /^\/user-screening\/panel-survey(\/|$)/, module: "panel_survey" },
